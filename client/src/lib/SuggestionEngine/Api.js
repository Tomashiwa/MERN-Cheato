...
export const vote = (type, user, sheet, done) => {
	axios
		.post(`/api/users/vote/add/${user.id}`, { sheetId: sheet._id, type: type })
	...
	axios
		.post(`/api/cheatsheets/vote/add/${sheet._id}`, { userId: user.id, type: type })
...
export const unvote = (type, user, sheet, done) => {
	axios
		.post(`/api/users/vote/remove/${user.id}`, { sheetId: sheet._id, type: type })
	...
	axios
		.post(`/api/cheatsheets/vote/remove/${sheet._id}`, { userId: user.id, type: type })
